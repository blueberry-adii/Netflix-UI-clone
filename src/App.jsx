    ...
    <>
      ...
      <section className="flex flex-col -top-12 overflow-x-hidden relative px-[354px] max-[1920px]:px-[148px] max-[1280px]:px-[80px] max-[960px]:px-[32px] max-[600px]:px-[24px] max-w-[1920px] mx-auto items-center z-50">
        <div className="w-full min-[1920px]:max-w-[1212px] mb-4">
          <h2 className="text-[18px] min-[960px]:text-[24px] min-[1920px]:text-[32px] font-sans font-bold">
            Trending Now
          </h2>
        </div>
          ...
          <ul className="grid grid-cols-4 max-[1280px]:grid-cols-2 max-[960px]:grid-cols-1 mt-6 gap-4">
            <li className="gradient-card relative rounded-2xl w-full">
              <div className="pt-8 pb-30 px-6 max-[1920px]:pb-24 -mt-6 min-[1920px]:-mt-4">
                ...
                <p className="text-[16px] opacity-70 mt-4">
            ...
            <li className="gradient-card relative rounded-2xl w-full">
              <div className="pt-8 pb-30 px-6 max-[1920px]:pb-24 -mt-6 min-[1920px]:-mt-4">
                ...
                <p className="text-[16px] opacity-70 mt-4">
                  ...
                  space made just for them — free with your membership0
                </p>
              </div>
              <div className="absolute bottom-4 right-4">
                <svg width="72" height="72" viewBox="0 0 72 72" fill="none">
      ...
      <section className="flex flex-col -top-12 overflow-x-hidden relative px-[354px] max-[1920px]:px-[148px] max-[1280px]:px-[80px] max-[960px]:px-[32px] max-[600px]:px-[24px] max-w-[1920px] mx-auto mt-16 z-50">
        ...
        <ul className="grid grid-cols-4 max-[1280px]:grid-cols-3 max-[960px]:grid-cols-2 max-[600px]:grid-cols-1 gap-y-2 gap-x-12 mb-12">
          <li>
            <a href="" className="text-[14px] opacity-70 underline">
              FAQ
            </a>
          </li>
          <li>
        ...
        <div className="flex h-8 gap-2">
          <div className="flex w-[120px] relative items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              role="img"
            ...
            <select
              className="w-full h-full bg-zinc-900/80 appearance-none text-white pb-[2px] border-1 border-[#605f5f] focus:outline-1 focus:outline-white rounded-sm"
              name="LanguageSelect"
            >
              <option
                lang="en"
